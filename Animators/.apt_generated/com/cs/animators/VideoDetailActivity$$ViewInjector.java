...
public class VideoDetailActivity$$ViewInjector {
  public static void inject(Finder finder, final com.cs.animators.VideoDetailActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131296364, "field 'mBtnOutline'");
    target.mBtnOutline = (android.widget.Button) view;
    view = finder.findRequiredView(source, 2131296359, "field 'mTxtName'");
    target.mTxtName = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131296358, "field 'mImgCover'");
    target.mImgCover = (android.widget.ImageView) view;
    view = finder.findRequiredView(source, 2131296361, "field 'mTxtYear'");
    target.mTxtYear = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131296360, "field 'mTxtCategory'");
    target.mTxtCategory = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131296357, "field 'mImgBg'");
    target.mImgBg = (android.widget.ImageView) view;
    view = finder.findRequiredView(source, 2131296363, "field 'mBtnPlay'");
    target.mBtnPlay = (android.widget.Button) view;
    view = finder.findRequiredView(source, 2131296365, "field 'mTxtPlayRecord'");
