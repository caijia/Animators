...
public class PlayerSeriesFragment extends DialogFragment {
	...
	private ArrayList<VideoDetailSeries> mTotalSeries = new ArrayList<VideoDetailSeries>();
	...
	private void getExtra(){
		...
		if(bundle != null)
		{
			mVideoId = bundle.getString(TestVitamioActivity.VIDEO_ID);
			ArrayList<VideoDetailSeries> series = bundle.getParcelableArrayList(TestVitamioActivity.TOTAL_SERIES);
			if(series != null)
			{
				mTotalSeries.addAll(series);
			}
		}
	}
