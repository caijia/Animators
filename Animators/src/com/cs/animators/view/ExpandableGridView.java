...
public class ExpandableGridView extends ExpandableListView {
			...
			for (int i=mNumColumns * childPosition; i<(mNumColumns * (childPosition + 1)); i++, index++) {
				...
				child.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						{
							mChildClickListener.onChildItemClick(ExpandableGridView.this, groupPosition, childPos);
						}
					}
				});
	...
	public interface OnItemChildClickListener{
		void onChildItemClick(ExpandableGridView gridView , int groupPosition , int childPosition );
	}
