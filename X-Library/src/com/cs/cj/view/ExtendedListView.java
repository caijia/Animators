...
public class ExtendedListView extends XListView implements OnScrollListener {
	...
	protected boolean awakenScrollBars(int startDelay, boolean invalidate) {
		...
		if (isAnimationPlayed == true && mScrollBarPanel != null && firstVisiblePosition >= headerViewsCount) {
