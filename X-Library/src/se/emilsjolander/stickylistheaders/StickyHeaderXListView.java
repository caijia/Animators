 ...
 * @date 2013-10-08
 */
public class StickyHeaderXListView extends StickyListHeadersListView implements OnScrollListener {
//    private static final String TAG = "XListView";
    ...
    public StickyHeaderXListView(Context context) {
        super(context);
        initWithContext(context);
    }

    public StickyHeaderXListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
    }

    public StickyHeaderXListView(Context context, AttributeSet attrs, int defStyle) {
